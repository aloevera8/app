jsPsych.plugins['turk-timing'] = (function() {

  var plugin = {};

  // get jsPsych to preload the images
  jsPsych.pluginAPI.registerPreload('turk-timing', 'rune_images', 'image');
  jsPsych.pluginAPI.registerPreload('turk-timing', 'gem_images', 'image');
  jsPsych.pluginAPI.registerPreload('turk-timing', 'ship_images', 'image');
  jsPsych.pluginAPI.registerPreload('turk-timing', 'pickaxe_images', 'image');
